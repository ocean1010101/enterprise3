        ...
        <div className="md:col-span-2 bg-white p-6 rounded-xl shadow-md border border-sky-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {basicMenu.map((item, i) => (
              <div key={i} className="p-4 rounded-lg bg-slate-50 border border-slate-100 hover:bg-sky-50/50 flex flex-col justify-between h-full">
                ...
                <p className="text-sm text-red-600 mt-3 font-bold">Allergens: {item.allergens}</p>
              </div>
            ))}
          </div>
        </div>
